...
const DepartmentPieChart = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const studentResponse = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/department-student-counts/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
        const studentData = studentResponse.data;

        const statsResponse = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/dashboard-stats/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
...
const ActiveStudentsBarChart = () => {
  ...
  useEffect(() => {
    const fetchActiveStudentCounts = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/active-student-counts/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
...
const AlumniStatusChart = () => {
  ...
  useEffect(() => {
    const fetchAlumniStatus = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/alumni-status-counts/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
        const data = response.data;
...
const JobCountBarChart = () => {
  ...
  useEffect(() => {
    const fetchJobCounts = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/job-counts/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchAdminData = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/current-user/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
        setAdminData({
  ...
  useEffect(() => {
    const fetchDashboardStats = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL || 'https://web-production-6135b.up.railway.app'}/api/dashboard-stats/`, {
          headers: { 'Content-Type': 'application/json' },
          withCredentials: true,
        });
        setStats({
